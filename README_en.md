...
Always seeking for latest software development technologies and a company that use them.
...
### Education
Tokyo Electronics College (Ikebukuro, Tokyo 1991-1992).
Diploma, Computer Science, 1992
Learn computer science and programming, study of lexical and syntactic parsers.
...
- Develop a payment system for SBPS(Softbank Payment Service).
- Build a game network infrastructure using CentOS on DELL R410s and Cisco Catalyst switchinghubs in a data center.
- Maintain KPI informations with SQL and scripting.
- Quit the company because of discontinuance of business.
...
- Build and replace computer system in computer classrooms and network infrastructures whole university with making RFP.
- Advise and submit library to way of installing and replacing their computer system.
