...
|詳細|機材設置調整、システム(ユーザ管理・メール配信等)設計・実装・管理、オンプレミスネットワーク全体設計(VLAN・管理ポート等)・実装・保守、中国人エンジニアとの現場調整(英語)、スケジュール管理、技術サポート|
|DB|MySQL5|
|言語|PHP、SQL、HTML、CSS、bash|
...
## その他
### 自己PR
子供の頃から親しんできたコンピュータ技術、その後若かりし頃より触れることになったインターネット・ネットワーク技術、そしてそれらに付随する技術は、いつでも追いかけ、可能な限り身につけていくようにしています。
たとえば、今では当たり前のインフラとなったクラウドコンピューティングですが、開発業務と運用業務の効率化として誕生したDevOpsの発想なくしては、開発からリリース、そしてそのインフ運用管理という一体化システムの継続が困難となりつつあります。こうした概念から誕生した新たな仮想化技術やコンテナ技術などを幅広く活用するべく、日々情報収拾と個人的探求に務めております。
また、コンピュータ言語は昔から興味対象であり、新たな言語が登場すれば1度は触れるように心がけています。その中で興味が湧いた言語については、さらに追求しています。
直接的なIT技術のみならず、ソフトウェア開発の効率化や合理化などの概念・技術や、可能ならコンピュータサイエンス・ソフトウェアエンジニアリングなどにも踏み込み、知識の幅を広げる努力をしております。
