...
|インフラ|Cisoc IOS|
|クラウド|Amazon AWS|
|運用業務|サーバ・インフラ構築運用管理、DB設計|
|開発業務|Webアプリケーション、CUI系プログラム、ゲーム管理システム、ブラウザゲーム開発・機能追加・改修、スマホアプリゲームUI開発|

### 独学・趣味

|項目|内容|
|---:|:---|
|言語|C++、Java、Go、Swift、C#、Python、Ruby、Scala (業務ではほぼ未使用)|
|インフラ|Ansible、Docker、Vagrant (業務での利用経験は有り)|

## 会社略歴(ゲーム関連)

|期間|業種|会社名|
|:---|:---|:-----|
|2013年9月〜現在|ゲーム開発|アプリコットン株式会社|
|2013年1月〜2013年8月|ゲーム開発|リライアンス・ビッグ・エンターテインメント・ジャパン株式会社|
|2012年6月〜2012年12月|ゲーム開発|ファンネル株式会社|
|2012年5月|ゲーム開発|6waves株式会社|
|2011年12月〜2012年4月|システム開発|ウィアー・エンジニアリング株式会社|
|2011年7月〜2011年11月|ゲーム開発|ルークデジタルエンターテインメント株式会社|
|1996年4月〜2011年7月|教育機関|明星大学(学校法人明星学苑)|
|1993年4月〜1996年3月|技術派遣|第一企画設計株式会社|
