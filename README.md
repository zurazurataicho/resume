...
## その他
### 自己PR
今では当たり前のインフラとなったクラウドコンピューティングですが、開発業務と運用業務の効率化として誕生したDevOpsの発想なくしては、開発からリリース、そしてそのインフ運用管理という一体化システムの継続が困難となりつつあります。こうした概念から誕生した新たな仮想化技術やコンテナ技術などを幅広く活用するべく、日々情報収拾と個人的探求に務めております。
