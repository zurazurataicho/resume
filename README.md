...
## その他
### 自己PR
　小学5年の頃から親しんできたコンピュータ技術、その後20代前半より触れることになったインターネット・ネットワーク技術、そしてそれらに付随する技術は常に追いかけ、いつでも現場で活用できるよう身につけています。
...
　また、コンピュータ言語は昔からの興味対象であり、専門学校の卒業論文のテーマでもありました。新たな言語が登場すれば1度は触れるように心がけています。その中で興味が湧いた言語については、さらに追求しています。
　また、ソフトウェア開発手法や合理化などの概念・技術や、可能ならコンピュータサイエンス・ソフトウェアエンジニアリングなど、興味のままに知識の幅を広げております。エンジニアによっては、こうした取り組みが勉強や努力という意識の方もおられるかもしれませんが、私にとってはITに関する新たな知見の獲得は常に普通のことであり、生活の一部になっております。
