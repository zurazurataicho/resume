...
### 自己PR
#### 新しいITの幅広い技術への探究心
クラウドのインフラが当然の世の中となった今、いわゆるDevOpsといわれる開発・運用環境に対する興味と実践への利用は、常に模索し、経験努力をしています。過去、一部技術は使用する機会に恵まれつつも、汎用的な利用・応用には関わる機会に恵まれませんでした。しかし、必ずや使われる技術を追い求めない理由はないという観点から、個人での利用・応用を研究する努力をし続けています。
#### 実装とインフラの幅広い経験・知識
